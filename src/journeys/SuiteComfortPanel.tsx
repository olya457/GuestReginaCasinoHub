...
export function SuiteComfortPanel() {
  const {comfortSettings, updateComfortSettings} = useVisitMemory();
  ...
  return (
    <VisitShell withTabBar>
      <PageHeading title="Guest Comfort" />
