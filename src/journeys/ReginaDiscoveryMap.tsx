...
import {AppButton, Badge, PageHeading, SearchField} from '../kit/controls';
import {colors} from '../styleGuide/styleTokens';
import {placeCategories, places} from '../conciergeDesk/cityHighlights';
import type {PlaceItem} from '../domain/visitTypes';
import {openDirections} from '../helpers/routeLauncher';

type ReginaDiscoveryMapProps = {
...
export function ReginaDiscoveryMap({onOpenPlace}: ReginaDiscoveryMapProps) {
  ...
  return (
    <VisitShell withTabBar>
      <PageHeading title="Explore Regina" />
