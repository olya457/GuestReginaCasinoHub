...
import {AppButton, EmptyState, PageHeading} from '../kit/controls';
import {colors} from '../styleGuide/styleTokens';
import {useVisitMemory} from '../guestMemory/VisitMemory';

export function ConciergeChatDesk() {
  const {assistantMessages, askAssistant, clearAssistant} = useVisitMemory();
  ...
  return (
    <VisitShell withTabBar scroll={false}>
      <PageHeading
