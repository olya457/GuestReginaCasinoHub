...
const storageKeys = {
  savedEvents: 'guestRegina.savedEvents',
  savedPlaces: 'guestRegina.savedPlaces',
  reservations: 'guestRegina.reservations',
  assistantMessages: 'guestRegina.assistantMessages',
  comfortSettings: 'guestRegina.comfortSettings',
};
